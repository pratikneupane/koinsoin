  ...
  return (
    <>
      <Container className="p-4">
        <h1 className={`text-center mt-4 ${styles.headhead}`}>Frequently asked Questions</h1>
        ...
        <div className="text-center">
          <h1 className={styles.headfoot}>Still have a question?</h1>
          <div>
          ...
          <div>
            <button
              className={`mt-4 ${styles.buttonContact}`}
            >
              Contact us
            </button>
          </div>
